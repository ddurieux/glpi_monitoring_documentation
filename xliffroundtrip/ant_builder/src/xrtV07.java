...
public class xrtV07 extends JFrame implements ActionListener
{
    ...
    JButton buttonRoundTripper0 = new JButton("Choose file xml file to transform to XLIFF");
    JTextField textXRTrip0 = new JTextField(25);
    JButton buttonRoundTripper1 = new JButton("Choose file XLIFF file to transform to xml");
